...
description: End-to-end campaign orchestration from HubSpot audience to Knock workflow
compatibility: opencode
---

# Campaign Launcher

End-to-end campaign orchestration: HubSpot audience -> Knock audience -> SendGrid template -> Knock workflow, with confirmation at each stage.
...
```bash
curl -s -X PUT \
  -H "Authorization: Bearer knock_st_aBOcA5Q7jS9GprJkW-Iqhq5vl1vYr_Kz6ugFQiyvQI8G4g3w59cDLm0-8tuoVhJV" \
...
- **Knock service token:** `knock_st_aBOcA5Q7jS9GprJkW-Iqhq5vl1vYr_Kz6ugFQiyvQI8G4g3w59cDLm0-8tuoVhJV`
